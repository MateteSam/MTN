    ...
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-30">
        {slides.map((slide, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-slate-950/80 via-slate-950/60 to-slate-950/40"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center justify-center gap-12">
          ...
          {/* Release Date Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-mtn-yellow/10 border border-mtn-yellow/20 text-mtn-yellow text-xs font-bold tracking-widest uppercase animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="text-center space-y-6">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <button
                ...
                className="group relative px-12 py-6 bg-mtn-yellow text-black font-bold text-2xl rounded-none skew-x-[-12deg] hover:bg-yellow-300 transition-all duration-300 shadow-2xl hover:shadow-mtn-yellow/50 hover:scale-105 transform"
              >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center justify-center gap-16">
          ...
          <div className="text-center space-y-8 max-w-4xl">
            ...
            <div className="pt-8 flex items-center justify-center gap-4 opacity-60">
                <Wifi className="w-5 h-5 text-slate-500" />
                <span className="text-xs tracking-widest uppercase text-slate-500">Digital • Financial • Social</span>
            </div>
          </div>
