...
export const AUTHOR_BIO_FULL = `Dr. Charles Wirsuiy Snr is a media and tech researcher, empathetic journalism advocate, and Christian evangelist whose career spans over twenty-five years across broadcasting, research, and digital storytelling.\n\nHe holds an MSc in Journalism, an MPhil in Development Anthropology, and a Doctorate in Media Strategy—credentials that reflect both academic depth and practical mastery of communication in the modern age. Dr. Wirsuiy has worked and collaborated with leading international broadcast institutions in Germany, the United Kingdom, the United States, and South Korea, contributing to significant global conversations on development, technology, and Africa’s evolving media and technological landscape.\n\nBeyond journalism, he is a media entrepreneur and cultural historian. His ventures in FM radio broadcasting and digital publishing in Cameroon and South Africa have positioned him among a generation of African thinkers who see media not merely as an industry but as an instrument of nation-building. As a ghostwriter and editorial strategist, Dr. Wirsuiy has quietly shaped the voices of many authors and leaders across Africa and the diaspora. His work is characterised by precision, empathy, and an unwavering belief in the power of narrative to shape public destiny.\n\nWith 300 Million Connections: MTN & the African Tech Revolution, Dr. Wirsuiy extends his lifelong pursuit: documenting the making of modern Africa through the stories of its institutions, innovators, and invisible builders. He lives in South Africa and continues to work at the intersection of faith, people, technology, and the human story.`;

export const AUTHOR_BIO = AUTHOR_BIO_FULL.split('\n\n').slice(0,2).join('\n\n');
